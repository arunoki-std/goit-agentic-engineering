...
**End of session:** After work that involved a non-trivial problem, solution, or discovery, run `/wrap-up` — it applies the anti-banality filter and writes to e2e/INSIGHTS.md when warranted. Do not skip.
